...
public class ReservationServiceIntegrationTest {
        ...
        private CarDTO createTestCarDTO(Integer carId, VehicleType vehicleType, Car.CarStatus status) {
        ...
        private Car createTestCar(Integer carId, VehicleType vehicleType, Car.CarStatus status) {
                Car car = new Car();
                car.setCarId(carId);
